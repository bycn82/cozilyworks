/*
 * $Id: ControllerConfig.java 54929 2004-10-16 16:38:42Z germuska $ Copyright 1999-2004 The Apache
...
/**
 * <p>
 * A JavaBean representing the configuration information of a <code>&lt;controller&gt;</code>
...
public class ControllerConfig implements Serializable{
	...
	/**
	 * <p>
	 * The replacement pattern used to determine a context-relative URL from a {@link ForwardConfig}
	 * element. The pattern may consist of any combination of the following markers and characters:
	 * </p>
	 * <ul>
	 * <li><code><strong>$M</strong></code> - Replaced by the module prefix for the current
	 * module.</li>
	 * <li><code><strong>$P</strong></code> - Replaced by the <code>path</code> property of a
	 * {@link ForwardConfig} instance.</li>
	 * <li><code><strong>$$</strong></code> - Renders a literal dollar sign ("$") character in
	 * the resulting URL.</li>
	 * <li>A dollar sign followed by any other character is reserved for future use, and both
	 * characters are silently swallowed.</li>
	 * <li>All other characters in the pattern are passed through unchanged. </li>
	 * </ul>
	 * <p>
	 * If this property is set to <code>null</code>, a default pattern of <code>$M$P</code> is
	 * utilized, which is backwards compatible with the hard coded functionality in prior versions.
	 * </p>
	 */
	...
	/**
	 * <p>
	 * Should the <code>input</code> property of {@link ActionConfig} instances associated with
	 * this module be treated as the name of a corresponding {@link ForwardConfig}. A
	 * <code>false</code> value treats them as a module-relative path (consistent with the hard
	 * coded behavior of earlier versions of Struts.
	 * </p>
	 * 
	 * @since Struts 1.1
	 */
	...
	/**
	 * <p>
	 * The replacement pattern used to determine a context-relative URL from the <code>page</code>
	 * attribute of Struts tags and configuration properties. The pattern may consist of any
	 * combination of the following markers and characters:
	 * </p>
	 * <ul>
	 * <li><code><strong>$M</strong></code> - Replaced by the module prefix for the current
	 * module.</li>
	 * <li><code><strong>$P</strong></code> - Replaced by the <code>page</code> attribute
	...
	/**
	 * The fully qualified class name of the RequestProcessor implementation class to be used for
	 * this module.
	 */
	protected String processorClass="org.apache.struts.action.RequestProcessorExt";
