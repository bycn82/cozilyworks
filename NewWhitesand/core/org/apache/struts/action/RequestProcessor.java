/*
 * $Id: RequestProcessor.java 54929 2004-10-16 16:38:42Z germuska $ 
 *
...
public class RequestProcessor {
    ...
    protected ActionForward
        processActionPerform(HttpServletRequest request,
                             ...
                             ActionMapping mapping)
        throws IOException, ServletException {
    	System.out.println("processActionFerform");
		if(action instanceof CozilyAction)
		((CozilyAction)action).init(mapping,form,request,response);
        try {
