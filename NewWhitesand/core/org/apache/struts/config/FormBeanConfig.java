/*
 * $Id: FormBeanConfig.java 54929 2004-10-16 16:38:42Z germuska $ Copyright 1999-2004 The Apache
...
/**
 * <p>
 * A JavaBean representing the configuration information of a <code>&lt;form-bean&gt;</code>
...
public class FormBeanConfig implements Serializable{
	...
	/**
	 * The set of FormProperty elements defining dynamic form properties for this form bean, keyed
	 * by property name.
	 */
	...
	/**
	 * @deprecated The value to be returned by <code>getDynamic()</code> is now computed
	 *             automatically in <code>setType()</code>
	 */
	 ...
	 * <code>ActionMapping</code> instances as well as for the name of the request or session
	 * attribute under which the corresponding form bean instance is created or accessed.
	 */
	 ...
	 * </p>
	 * <p>
	 * If so, no changes to the existing registration of property names, data types, readability, or
	 ...
	 *                if this Class represents an abstract class, an array class, a primitive type,
	 *                or void; or if instantiation fails for some other reason
	 */
	...
	/**
	 * Add a new <code>FormPropertyConfig</code> instance to the set associated with this module.
	 * 
	 * @param config
	...
	/**
	 * Return the form property configuration for the specified property name, if any; otherwise
	...
	/**
	 * Return the form property configurations for this module. If there are none, a zero-length
	 * array is returned.
	 */
	...
	// ------------------------------------------------------ Protected Methods
	/**
	 * Return the <code>Class</code> instance for the form bean implementation configured by this
	 * <code>FormBeanConfig</code> instance. This method uses the same algorithm as
	 * <code>RequestUtils.applicationClass()</code> but is reproduced to avoid a runtime
	 * dependence.
	 */
