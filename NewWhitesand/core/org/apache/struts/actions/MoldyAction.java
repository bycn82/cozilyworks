...
public abstract class MoldyAction extends CozilyAction{
	@Override
	protected void onInit(ActionMapping mapping,ActionForm form,HttpServletRequest request,HttpServletResponse response){
